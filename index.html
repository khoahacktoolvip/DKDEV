<html lang="vi-VN" class="dark" data-title-loader="DangKhoa_Coder">
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0"/>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>DangKhoa_Coder - Home</title>
        <meta property="og:title" content="Nguyễn Đăng Khoa | Profile Home">
        <link rel="shortcut icon" href="https://i.ibb.co/rGMn65d/boss.webp" type="image/x-icon">
        <meta name="description" content="Hi my name is DangKhoa / A freelance / web developer / vexer">
        <meta name="keywords" content="NguyenDangKhoa,DangKhoa_Dev,DangKhoa_Coder">
        <link rel="canonical" href="https://dangkhoa.shop/">
        <meta content="NguyenDangKhoa" name="author">
    ...
    <body>
        <div class="flex justify-center bg-background">
            ...
            <div class="td-loading-v2">
                <!-- <img class="loading2 none" src="https://i.imgur.com/dxVZLOG.png" alt="Thanh Diệu Loader Screen V2"> -->
                <img class="loading2 none" src="https://i.postimg.cc/KY3Vfz72/827d8bcb8542081c5153.jpg" alt="DangKhoa_Coder">
                <div class="ws-loader-text">
                    <h4>Nguyễn Đăng Khoa</h4>
            ...
            <main class="z-10 flex min-h-screen w-screen max-w-[60rem] flex-col items-center px-4 text-[0.92rem] leading-relaxed sm:px-7 lg:px-10">
                        ...
                        <nav class="relative mx-auto flex w-full items-center justify-between sm:flex sm:items-center">
                            ...
                            <h1 class="flex-none text-xl font-semibold transition-all duration-300 group-[.not-top]:ms-3 sm:group-[.not-top]:ms-5">
                                <span class="magic">
                                    ...
                                    <span class="magic-text">DangKhoa_Dev Home</span>
                                </span>
                            </h1>
                ...
                <div class="flex w-full flex-col gap-y-10 md:w-4/5 lg:w-5/6">
                    <section class="animate flex flex-col items-center gap-y-7 show">
                        <div class="relative">
                            <img src="https://i.postimg.cc/KY3Vfz72/827d8bcb8542081c5153.jpg" alt="Avatar" class="author-avatar rounded-full border p-1">
                            <img class="crown3" src="./assets/img/mong-vuot-rong.png">
                        </div>
                        <div class="flex flex-col items-center gap-y-4">
                            <h1 class="text-3xl font-bold flex items-center">
                                Nguyễn Đăng Khoa <img class="blue-tick ml-2" src="./assets/img/icon/tick.png">
                            </h1>
                            <p>
                                I LOVE <span class="bg-primary-foreground rounded text-transparent hover:text-inherit transition-colors cursor-pointer">
                                 Nguyễn Thị Tú.</span>
                            </p>
                            <div class="flex flex-wrap justify-center gap-x-7 gap-y-3">
                                ...
                                <a class="flex flex-row items-center justify-center gap-x-2 hover:opacity-75 transition-all" href="https://github.com/" target="_blank">
                            ...
                            <div class="grid grid-cols-1 gap-x-4 gap-y-2 sm:grid-cols-2 sm:gap-y-4">
                                    ...
                                    <div class="relative flex flex-row items-center gap-x-4 px-2 py-1.5 transition-all">
                                        ...
                                        <div class="z-20 flex flex-col">
                                            <div class="font-medium">
                                                Ai Là Nghìn Phú <i data-ws-copy="https://www.mediafire.com/file/kh0wp9049fbhqnw/NH%25C3%2593M_3.pptx/file" class="ri-file-copy-line text-muted-foreground cursor-pointer"></i>
                                            </div>
                                ...
                                <a class="me-10 group relative text-sm leading-normal no-underline hover:bg-transparent">
                                    <div class="relative flex flex-row items-center gap-x-4 px-2 py-1.5 transition-all">
                                        ...
                                        <div class="z-20 flex flex-col">
                                            <div class="font-medium">
                                            Canva Thuyết Trình <i data-ws-copy="https://www.canva.com/design/DAG3RcM-mDw/IpVdAdq9JK-V2Rk45AMTUw/edit?utm_content=DAG3RcM-mDw&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" class="ri-file-copy-line text-muted-foreground cursor-pointer"></i>
                                            </div>
                                            <div class="font-normal text-muted-foreground">
                                            </div>
                                        </div>
                    ...
                    <section class="animate flex flex-col gap-y-5 md:flex-row md:gap-y-0 show">
                        ...
                        <div class="flex flex-1 flex-col gap-y-3">
                            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                <a class="group overflow-hidden relative flex flex-col gap-y-3 rounded-2xl border border-border bg-primary-foreground transition-all hover:border-foreground/25 hover:shadow-sm" data-fancybox="gallery" data-src="https://i.postimg.cc/KY3Vfz72/827d8bcb8542081c5153.jpg">
                                    <img src="https://i.postimg.cc/KY3Vfz72/827d8bcb8542081c5153.jpg" alt="Img" class="absolute top-0 h-full w-full object-cover">
